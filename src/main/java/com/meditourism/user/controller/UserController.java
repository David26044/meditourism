package com.meditourism.user.controller;

import com.meditourism.email.service.EmailService;
import com.meditourism.exception.ResourceNotFoundException;
import com.meditourism.jwt.JwtService;
import com.meditourism.user.dto.UserDTO;
import com.meditourism.user.dto.UserResponseDTO;
import com.meditourism.user.entity.UserEntity; // Aunque no se usa directamente en el controlador, se mantiene para contexto.
import com.meditourism.user.repository.UserRepository; // Aunque no se usa directamente en el controlador, se mantiene para contexto.
